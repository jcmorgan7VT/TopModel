...
p_load(tidyverse, terra, tidyterra, whitebox, scales, wesanderson, caret, plotly,
       ggnewscale, sf, rgeoboundaries, elevatr)
...
ggplot()+
  ...
  geom_spatraster(data = crop1, alpha = 0.5)+
    geom_sf(data = fb_outline, fill = "darkslategray3", color = "black", alpha = 0.3) +
...
ggplot()+
  ...
  scale_fill_gradientn(colors = c("black", "gray9", "gray48","lightgray", "white"))+
    new_scale_fill() +
  geom_spatraster(data = crop1, alpha = 0.5)+
    geom_sf(data = zz_outline, fill = "darkslategray3", color = "black", alpha = 0.3) +
...
ggplot()+
  ...
  scale_fill_gradientn(colors = c("black", "gray9", "gray48","lightgray", "white"))+
    new_scale_fill() +
  geom_spatraster(data = crop1, alpha = 0.5)+
    geom_sf(data = w3_outline, fill = "darkslategray3", color = "black", alpha = 0.3) +
