...
# Testing sequences, running models deprec
```{r plot-W3-model-accuracy}
#final plot
...
rbind(all_pk,
      all_twi, 
      mutate(all_bfs, method = "BFS"),
      mutate(all_event, method = "Event")
      ) %>% 
  filter(timescale == "30mins")

four_colors <- c("#bb4430", "#231f20","#7ebdc2",  "#f3dfa2")
