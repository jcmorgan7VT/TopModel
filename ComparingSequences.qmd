...
topo <- data.frame("Watershed" = c("W3", "FB", "ZZ"),
                   ...
                   "Maximum Drainage Density m/m^2" = c(length_w3 / area_w3,
                                                        length_fb / area_fb,
                                                        length_zz / area_zz),
                   "Slope" = c(w3_avg_slope$mean, fb_avg_slope$mean, zz_avg_slope$mean),
                   "Elevation_lower" = c(w3_elev$min, fb_elev$min, zz_elev$min),
                   "Elevation_upper" = c(w3_elev$max, fb_elev$max, zz_elev$max),
                   "Expansion Coefficient (m)" = c(w3_beta,
                                                   fb_beta,
                                                   zz_beta),
