...
```{r combine-ZZ-events}
ZZall_events <- rbind(ZZstage23, 
                      mutate(ZZstage24, event_id = event_id + 8), 
                      mutate(ZZstage25, event_id = event_id + 14))
write_csv(ZZall_events, "ZZ_events.csv")
```
