...
12/16/24
Read in air pressure measured at the headquarters: https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-hbr.330.1
```{r}
#read in air pressure, use instead of my air pressure for stage-Q relationship
pressure <- read_csv("https://portal.edirepository.org/nis/dataviewer?packageid=knb-lter-hbr.330.1&entityid=5774f480b38484ba9a954ef2db8b3f1a")
```
