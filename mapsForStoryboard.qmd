...
#I think it makes more sense to make the calc_support function, then put that inside a loop that will iterate through groups and add up the support for each group, to find a total for the scenario
...
iterate_groups("r_23", "r_6", input, minutes(30))
