...
w3_tpi <- extract(rast(tpi_output), locs_shape) %>% 
  rename("tpi" = `10mdem_tpi`)
...
##test versions, returns all combinations between two sensors, instead of prop value
```{r all-combos}
...
#test function
calc_support_combos("r_23", "r_6", input)
