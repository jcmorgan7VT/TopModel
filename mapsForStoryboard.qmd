...
#extract values
bind_cols(extract(rast(flowacc_output), locs_shape),
          extract(rast(slope_output), locs_shape),
          extract(rast(twi_output), locs_shape),
          extract(rast(tpi_output), locs_shape),
          by = "ID")
W3_uaa_ex <- extract(rast(flowacc_output), locs_shape)


rast(twi_output)#should be in units of 3 m2, so 200 is 600 m2 I 
